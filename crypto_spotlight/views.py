...
def donate(request):
    ...
    # Generate QR codes
    bitcoin_qr_path = os.path.join(settings.MEDIA_ROOT, "qr", bitcoin_qrcode_file_name)
    ethereum_qr_path = os.path.join(
        settings.MEDIA_ROOT, "qr", ethereum_qrcode_file_name
    )
    ...
    context = {
        ...
        "ethereum_qr": os.path.join(
            settings.MEDIA_URL, "qr", ethereum_qrcode_file_name
        ),
    }
