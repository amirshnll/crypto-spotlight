...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "crypto_website.context_processors.website_name",
                "crypto_website.context_processors.website_domain",
                "crypto_website.context_processors.model_name",
                "crypto_website.context_processors.website_twitter",
                "crypto_website.context_processors.website_linkedin",
            ],
        },
    },
]
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "crypto_website", "static"),
]
